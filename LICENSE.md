...
This License governs the use, study, modification, and distribution of all materials, code, symbols, documentation, architecture, runtime definitions, and system concepts contained within this repository, collectively referred to as **the System**.
...
The Lab License may evolve.

Future versions will be published in this repository and supersede prior editions once adopted by the maintainer.

The repository history is treated as a runtime ledger. Prior versions may remain visible for historical, archival, and provenance purposes, but the active license version is the version currently published in `LICENSE.md` unless otherwise stated by the maintainer.
